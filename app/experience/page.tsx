...
const Experience = async () => {
  ...
  const [experience, education, customComponents] = await Promise.all([experienceData, educationData, customData]);
  ...
  return (
    <main className='p-experience'>
      <section className='my-16 o-container o-container--lg'>
        <LContainer>
          <h1 className='text-h1 text-center mb-16 font-bold'>{ experience.header }</h1>
          <ul>
            {
      ...
      <section className='my-16 o-container o-container--lg'>
        <LContainer>
        <h1 className='text-h1 text-center mb-16 font-bold'>{ education.header }</h1>
          <ul>
            {
